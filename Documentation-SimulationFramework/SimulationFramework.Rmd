...
This is the final source-able function:
```{r}
FUN.SimulationFramework <- function(
  ...
  return(list(Network = Network_igraph, Traits = Trait_means, K = k_vec, Simulation = ID_ls))
}
```
